    ...
    auto config_no_instances_json = R"(
{
    ...
    auto config = bmw::mw::com::impl::configuration::Parse(std::move(config_no_instances_json));
    ...
    auto config_no_events_json = R"(
{
    ...
    auto config = bmw::mw::com::impl::configuration::Parse(std::move(config_no_events_json));
    ...
    auto config_no_fields_json = R"(
{
    ...
    auto config = bmw::mw::com::impl::configuration::Parse(std::move(config_no_fields_json));
